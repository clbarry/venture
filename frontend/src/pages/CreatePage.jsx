   ...
   <>
      ...
      <div className="create-page">
        ...
        <div className="create-page-description"> 
          <h2 className="create-page-headline">Create an itinerary & plan your next adventure.</h2>
          ...
          <div className="create-form-card">
            ...
            <div className="form-entry">
              ...
              <select name="fitnessLevel" id="fitnessLevel" required>
                <option value="">Select fitness level needed for this itinerary</option>
                <option value="easy">Easy: mostly flat walking, short distances, frequent rest stops.</option>
                <option value="moderate">Moderate: some hills, longer distances, occasional rest stops.</option>
                <option value="active">Active: full-day hikes, uneven terrain, moderate elevation gain. </option>
                <option value="challenging">Challenging: long, strenuous hikes with steep climbs and rough terrain.</option>
                <option value="strenuous">Strenuous: multi-day trekking, high altitude, sustained physical exertion.</option>
              </select>
            </div>
            ...
            <div className="form-entry">
              ...
              <input type="text" name="collaborators" id="collaborators" placeholder="@friend1, @friend2, @friend3..." />
            </div>
          </div> {/* form create-form-card end */}
